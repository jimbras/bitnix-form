...
class CheckboxTest extends TestCase {
    ...
    public function testConstructor() {
        $input = new Checkbox('foo', [
            'value' => 'bar',
            'label' => 'Foo',
            'usage' => 'Foo usage...'
        ]);

        $this->assertEquals('checkbox', $input->attribute('type'));
        ...
        $this->assertFalse($input->attribute('indeterminate'));
        ...
        $input = new Checkbox('foo', [
            'value' => 'bar',
            'checked' => true,
            'indeterminate' => 'whatever...'
        ]);

        $this->assertFalse($input->attribute('checked'));
        $this->assertTrue($input->attribute('indeterminate'));
    ...
    public function testUpdateNotSubmitted() {
        ...
        $input = new Checkbox('foo', ['value' => 'bar', 'checked' => true]);
    ...
    public function testUpdateSubmitted() {
        ...
        $input = new Checkbox('foo', ['value' => 'bar', 'indeterminate' => true]);
